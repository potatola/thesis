...
\cauthor{耿玉峰} \cnumber{1301214299} \csubsub{网络视频信息处理}
\csupervisor{郭宗明\ 研究员}
%\cassosupervisor{~~教~~授}
...
\edegree{Master} \esubject{Computer Applied Technology} \eauthor{Yufeng Geng} \esupervisor{Professor Zongming Guo}
\edepartment{Institute of Computer Science and Technology}
